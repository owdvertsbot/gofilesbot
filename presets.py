...
class Presets(object):
    ...
    NO_MEDIA = "നിങ്ങൾ ചോദിച്ച : <b>{}</b> <b>ഇപ്പോൾ " \
               "ലഭ്യമല്ല 💔</b>\n<code>ലഭ്യമല്ലാത്തതിൻ്റെ കാരണങ്ങൾ : 👇\n\n<b>🚫 റിലീസ് " \
               "ആയിട്ടില്ല🚫</b></code>\n❎ <a href='https://www.google.com/search?q={}'> Spelling തെറ്റാണ് (ആണെങ്കിൽ ഇവിടെ ക്ലിക്ക് ചെയ്ത് ശെരിയായ Spelling കണ്ട്പിടിക്കുക.)</a>\n" \
               "<code>🚫 Unwanted texts in Msgs 🚫</code>"
