...
class Presets(object):
    ...
    BOT_PM_TEXT = "<b>Sorry.. 😢</b>\n\n<b>ബോട്ട് pm ൽ വർക്ക് ചെയ്യില്ല, എൻ്റെ ഗ്രൂപ്പിൽ ചോദിക്കുക. ഞാൻ ആ ഫയലുകൾ Reply ആയി നിങ്ങളുടെ pm ൽ അയക്കുന്നാതാണ്</b>" \
                  "എൻ്റെ DB യിൽ ലഭ്യമാണെങ്കിൽ!</b>"
    PM_ERROR = "<b>മൂവി ഫയലുകൾ അയക്കാൻ പറ്റുന്നില്ല</b> ⛔️\nതാഴെ ഉള്ള ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക\nഎന്നിട്ട് നിങ്ങൾ ചോദിച്ച മൂവി ഒരു പ്രാവശ്യം കൂടി ഈ ഗ്രൂപ്പിൽ ചോദിക്കുക!</code>"
    MEDIA_SEND_TEXT = "<b>മൂവി ഫയലുകൾ നിങ്ങളുടെ pm ൽ അയച്ചിട്ടുണ്ട് 🎉🎉🎉</b>"
    NO_MEDIA = "<b>നിങ്ങൾ ചോദിച്ച:</b> <b>{}</b><b> മൂവി ഇപ്പോൾ  " \
